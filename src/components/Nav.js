        ...
        >
          <div className="nav__account__dropdown">
            <div className="nav__drop__kids">
              <a href="#">
                <img class="kids-icon" src="https://occ-0-4796-993.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABdTeFDWGGsM48NmQvPPwI9VDJ_aeLDk_7U5sowYemKcU_IW57cQR5Vn1fJU8F2tlp9Atv3V13C6rQ4-AT88O_8asZcow4xY.png?r=15b" alt=""></img>
                키즈
              </a>
            </div>
